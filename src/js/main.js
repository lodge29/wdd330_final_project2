...
// Utah cities API
const ut_cities_api =
  "https://services1.arcgis.com/99lidPhWCzftIe9K/arcgis/rest/services/CitiesTownsLocations/FeatureServer/0/query?where=1%3D1&outFields=NAME,COUNTY&outSR=4326&f=json";
...
weatherButton.addEventListener("click", async () => {
  ...
  if (city) {
    try {
      ...
      weatherData.innerHTML =
        "<p id='validation'>*** Error fetching weather data ***</p>";
    }
  } else {
    weatherData.innerHTML =
      "<p id='validation'>*** Please select a city ***</p>";
  }
});

// EVENT to enhance the dropdown list view
cityInput.addEventListener("focus", () => {
  cityInput.style.width = "200px";
  cityInput.style.height = "50px";
});

cityInput.addEventListener("blur", () => {
  cityInput.style.width = "100px";
  cityInput.style.height = "40px";
});
